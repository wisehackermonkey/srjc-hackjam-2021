...
module.exports = {
  ...
  replaceFileTextFn: (fileText, templateName, utils) => {
    ...
    return fileText
      .replace(/srjc-hackjam-2021/g, templateName)
      .replace(
        /SrjcHackjam_2021/g,
  ...
  renameFileFn: (fileName, templateName, utils) => {
    ...
    return base.replace(/srjc-hackjam-2021/gm, templateName);
  },
  renameSubDirectoriesFn: (directoryName, templateName, _utils) => {
    ...
    return directoryName.replace(/srjc-hackjam-2021/g, newDirectoryName);
  }
};
