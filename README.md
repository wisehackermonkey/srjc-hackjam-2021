...
[![](https://contrib.rocks/image?repo=wisehackermonkey/srjc-hackjam-2021)](https://github.com/wisehackermonkey/srjc-hackjam-2021/graphs/contributors)
...
# License
#### MIT © wisehackermonkey
[![MIT](https://img.shields.io/github/license/wisehackermonkey/srjc-hackjam-2021.svg)](https://github.com/wisehackermonkey/srjc-hackjam-2021/blob/master/LICENSE)
-->
...
[![GitHub release](https://img.shields.io/github/release/wisehackermonkey/srjc-hackjam-2021.svg)](https://GitHub.com/wisehackermonkey/srjc-hackjam-2021/releases/)
[![GitHub tag](https://img.shields.io/github/tag/wisehackermonkey/srjc-hackjam-2021.svg)](https://GitHub.com/wisehackermonkey/srjc-hackjam-2021/tags/)
[![GitHub pull-requests](https://img.shields.io/github/issues-pr/wisehackermonkey/srjc-hackjam-2021.svg)](https://GitHub.com/wisehackermonkey/srjc-hackjam-2021/pull/)
...
```bash
cd ~
git clone https://github.com/wisehackermonkey/srjc-hackjam-2021.git
cd srjc-hackjam-2021
...
git clone https://github.com/wisehackermonkey/srjc-hackjam-2021.git
cd srjc-hackjam-2021
docker build -t wisehackermonkey/srjc-hackjam-2021:latest .  
```
### Run
```bash
docker run -it --rm --name wisehackermonkey/srjc-hackjam-2021:latest  
```
### Docker-compose
```bash
...
docker build -t wisehackermonkey/srjc-hackjam-2021:latest .
docker login
docker push wisehackermonkey/srjc-hackjam-2021:latest
```
